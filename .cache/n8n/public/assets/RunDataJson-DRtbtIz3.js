const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/RunDataJsonActions-7l2QvE2z.js","assets/index-DuLlH1tF.js","assets/index-DnpNicM9.css","assets/_commonjs-dynamic-modules-TGKdzP3c.js","assets/RunDataJsonActions-B2jW3_UG.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, aY as useNDVStore, cM as useTelemetryContext, r as ref, gk as useElementSize, x as computed, he as executionDataToJson, h as createElementBlock, g as openBlock, e as createBlock, i as createVNode, w as withCtx, f as createCommentVNode, l as unref, du as defineAsyncComponent, dt as Suspense, hf as VueJsonPretty, h9 as __unplugin_components_0, n as normalizeClass, ha as MappingPill, gg as Draggable, aU as __vitePreload, hb as shorten, hd as getMappedExpression, bp as useExternalHooks, al as useTelemetry, hg as isString, hh as nonExistingJsonPath, _ as _export_sfc } from "./index-DuLlH1tF.js";
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const LazyRunDataJsonActions = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataJsonActions-7l2QvE2z.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0)
    );
    const props = __props;
