import { d as defineComponent, r as ref, eD as toRefs, v as useSettingsStore, o as onMounted, h as createElementBlock, g as openBlock, n as normalizeClass, i as createVNode, l as unref, w as withCtx, j as createBaseVNode, m as N8nHeading, k as createTextVNode, t as toDisplayString, c as useI18n, e as createBlock, f as createCommentVNode, e0 as N8nFormInputs, p as N8nText, q as N8nButton, s as N8nCard, eE as MFA_FORM, M as MFA_AUTHENTICATION_CODE_INPUT_MAX_LENGTH, eF as MFA_AUTHENTICATION_RECOVERY_CODE_INPUT_MAX_LENGTH, eG as mfaEventBus, _ as _export_sfc, u as useUsersStore, dZ as useSSOStore, a2 as useRoute, b as useRouter, a as useToast, x as computed, d8 as reactive, V as VIEWS, al as useTelemetry, eH as MFA_AUTHENTICATION_REQUIRED_ERROR_CODE } from "./index-DuLlH1tF.js";
import { A as AuthView } from "./AuthView-z58gFjsc.js";
import { L as Logo } from "./Logo-DF7Ve1nG.js";
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const focusMfaCodeAfterPasswordManager = () => {
      setTimeout(() => {
        if (mfaFormRef.value) {
          const container2 = mfaFormRef.value.$el;
          if (!container2) return;
          const inputElement = container2.querySelector('input[name="mfaCode"]');
          if (inputElement) {
            inputElement.focus();
          }
        }
