import { d as defineComponent, a2 as useRoute, r as ref, x as computed, V as VIEWS, c as useI18n, a7 as watch, e as createBlock, g as openBlock, gj as N8nTabs, aG as useTemplateRef, h as createElementBlock, n as normalizeClass, X as renderSlot, i as createVNode, l as unref, ef as N8nActionToggle, w as withCtx, aa as _sfc_main$3, _ as _export_sfc, b as useRouter, au as useProjectsStore, af as useSourceControlStore, v as useSettingsStore, Q as useUIStore, aF as ProjectTypes, ft as isIconOrEmoji, aB as getResourcePermissions, gk as useElementSize, gl as useResizeObserver, j as createBaseVNode, f as createCommentVNode, fu as __unplugin_components_0, m as N8nHeading, k as createTextVNode, t as toDisplayString, p as N8nText, q as N8nButton, K as mergeProps, a9 as Tooltip, gm as PROJECT_DATA_STORES } from "./index-DuLlH1tF.js";
    ...
    const sectionDescription = computed(() => {
      if (projectPages.isSharedSubPage) {
        ...
        return i18n.baseText(
          settingsStore.isDataStoreFeatureEnabled ? "projects.header.overview.subtitleWithDataTables" : "projects.header.overview.subtitle"
        );
      } else if (isPersonalProject.value) {
        return i18n.baseText(
          settingsStore.isDataStoreFeatureEnabled ? "projects.header.personal.subtitleWithDataTables" : "projects.header.personal.subtitle"
        );
      }
      return null;
    });
