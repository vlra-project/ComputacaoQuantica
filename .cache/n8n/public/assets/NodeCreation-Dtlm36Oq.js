const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/NodeCreator-DUoi7nAW.js","assets/index-DuLlH1tF.js","assets/index-DnpNicM9.css","assets/NodeCreator-COTYfPaK.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, Q as useUIStore, cH as useFocusPanelStore, fk as useAssistantStore, hn as useActions, h as createElementBlock, g as openBlock, f as createCommentVNode, e as createBlock, n as normalizeClass, i as createVNode, w as withCtx, aa as _sfc_main$1, l as unref, c as useI18n, cg as KeyboardShortcutTooltip, q as N8nButton, j as createBaseVNode, d9 as _sfc_main$2, k as createTextVNode, t as toDisplayString, a9 as Tooltip, du as defineAsyncComponent, dt as Suspense, F as Fragment, aU as __vitePreload, dv as NODE_CREATOR_OPEN_SOURCES, ho as getMidCanvasPosition, b0 as STICKY_NODE_TYPE, al as useTelemetry, hp as DEFAULT_STICKY_WIDTH, hq as DEFAULT_STICKY_HEIGHT, _ as _export_sfc } from "./index-DuLlH1tF.js";
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    const LazyNodeCreator = defineAsyncComponent(
      async () => await __vitePreload(() => import("./NodeCreator-DUoi7nAW.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0)
    );
    const props = __props;
    const emit = __emit;
